            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (let item in data) {
                        ...
                        html += `
                        <li class="product-box-contain" id="mini_cart_${product.rowId}">
                            <div class="drop-cart">
                                <a href="{{ url('product-detail') }}/${product.options.slug}" class="drop-image">
                                ...
                                <div class="drop-contain">
                                    ...
                                    <h6><span>${product.qty} x</span> {{$settings->currency_icon}} ${product.price}</h6>
                                    <button class="close-button close_button remove_sidebar_product" data-id="${product.rowId}">
