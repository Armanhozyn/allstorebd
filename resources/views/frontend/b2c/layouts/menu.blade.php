            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['vendor.index'])}}" href="{{route('vendor.frontend.index')}}">vendors</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('signup.b2b')}}">Sign up for B2B</a></li>
                        @if (auth()->check())
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <ul>
                        ...
                        <li><a href="{{route('vendor.frontend.index')}}">vendor</a></li>
